...
<div class="page-content">
              ...
              <div class="card">
							...
							<div class="mb-3">
                              ...
                              <div class="mb-3">
                               ...
                               <div class="mb-3">
                                ...
                                data-role="tagsinput" value="Red,Blue,Yellow">
							  </div>

							  <div class="mb-3">
								<label for="inputProductDescription" class="form-label">Short Description</label>
								<textarea class="form-control" id="" name="short_desc" id="inputProductDescription" rows="3"></textarea>
							  </div>

                              <div class="mb-3">
								<label for="inputProductDescription" class="form-label">Long Description</label>
								<textarea class="form-control" id="mytextarea" name="long_desc" id="inputProductDescription" rows="3"></textarea>
							  </div>
				...
				<img src="" id="mainThmb" />
								{{-- <input type="file" name="product_thumbnail" id="formFile" 
                               ...
                               <div class="mb-3">
								...
								{{-- <input type="file" id="formFileMultiple" name="multi_img[]" 
                                class="form-control" id="multiImg" multiple="" > --}}
							...
							<div class="border border-3 p-4 rounded">
                              <div class="row g-3">
								<div class="col-md-6">
								  ...
								  <div class="col-md-6">
									<label for="inputCostPerPrice" class="form-label">Product Code <Code></Code></label>
					...
					<select name="subcategory_id" class="form-select" id="inputCollection">
						<option></option>
                                   ...
                                   {{-- <div class="col-12">
									<label for="inputCollection" class="form-label">Subcategories</label>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hot_deals" value="1" id="flexCheckDefault"></input>
                                ...
                                <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault"></input>
                                ...
                                <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" name="special_offer"></input>
                                ...
                                <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" name="special_deals"></input>
